        ...
        # Dictionary to track last modified timestamps and sizes of files
            ...
            while True:
                ...
                # Track if any updates were found
                    ...
                    # Look for the file in both capitalized and lowercase Downloads folders
                            file_paths = [
                            ...
                            # Check if file was modified
                                    if file_path not in last_modified or last_modified[file_path] != current_time:
                                # Register the updated resource with new size
                            ...
                            if not found_file:
                                #elf.log_message(f"[UPDATE] Resource {file_name}.{file_extension} not found locally")
                                pass
                ...
                # Check every thirty seconds
                        ...
                        time.sleep(30)  # Still wait before trying again
